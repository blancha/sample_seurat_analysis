---
title: "Generate Seurat object with selected number of principal components, and resolution 0.6"
...
knitr::opts_chunk$set(message = FALSE,
                      ...
                      cache = TRUE,
                      cache.lazy=FALSE,
                      cache.path = paste0("cache", "/", "4-generate_seurat_object_with_selected_pcs_and_resolution_0.6", "/"),
                      fig.keep = "all",
                      dev = c("png", "pdf"),
                      fig.path = paste0("figures", "/", "4-generate_seurat_object_with_selected_pcs_and_resolution_0.6", "/"))
```
