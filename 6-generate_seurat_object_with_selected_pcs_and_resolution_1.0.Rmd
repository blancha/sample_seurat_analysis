---
title: "Generate Seurat object with selected number of principal components, and resolution 1.0"
...
knitr::opts_chunk$set(message = FALSE,
                      ...
                      cache = TRUE,
                      cache.lazy=FALSE,
                      cache.path = paste0("cache", "/", "6-generate_seurat_object_with_selected_pcs_and_resolution_1.0", "/"),
                      fig.keep = "all",
                      dev = c("png", "pdf"),
                      fig.path = paste0("figures", "/", "6-generate_seurat_object_with_selected_pcs_and_resolution_1.0", "/"))
```
